...
<body>
	...
	<div id="navigation">
		<ul class="nav" id="nav">
			<li><a href="index.php" id="homeLink" class="navlink">Home</a></li>
			...
			<li><a class="navlink">Auto Docs</a>
				<ul><li><a href="php/jumpPointDoc.php">Run jumpPointDoc</a></li>
					<li><a href="doc">Output Docs</a></li></ul></li>			
			<li><a class="navlink">Github</a>
				<ul><li><a href="https://github.com/bit286/bit562" id="blessedLink" target="repo">Blessed Repository</a></li>
					<li><a class="sub">Remote Repos</a>
						<ul><li class="topline"><a href="https://github.com/edwinski-lap/bit562" target="repo">Ed The Decider</a></li>
							...
							<li><a href="https://github.com/AlfredAbenes/bit562" target="repo">Alfred</a></li>
			...
			<li><a class="navlink">References</a>
				<ul><li><a href="http://php.net/manual/en/index.php" target="repo">PHP Manual</a></li>
					<li><a href="http://www.simpletest.org/" target="repo">Simpletest</a></li>
